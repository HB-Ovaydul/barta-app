...
<!--          </div>-->
        ...
        <!-- User Meta -->
        <div>
          @if (isset(Auth::guard('register')->user()->username))
          <h1 class="font-bold md:text-2xl">{{ Auth::guard('register')->user()->username }}</h1>
        @else
          Username Not Found!
        @endif
...
<!--        </div>-->
    ...
    <a href="{{ route('edit.profile',Auth::guard('register')->user()->id) }}" type="button" class="-m-2 flex gap-2 items-center rounded-full px-4 py-2 font-semibold bg-gray-100 hover:bg-gray-200 text-gray-700">
