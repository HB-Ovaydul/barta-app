...
<section class="bg-white border-2 p-8 border-gray-800 rounded-xl min-h-[350px] space-y-8 flex items-center flex-col justify-center">
    ...
    <div class="flex flex-row gap-16 justify-center text-center items-center">
        ...
        <div class="flex flex-col justify-center items-center">
          <h4 class="sm:text-xl font-bold">{{ $totalPostCount->comments_count }}</h4>
...
<article class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-4 py-5 sm:px-6">
    ...
    <div class="py-4 text-gray-700 font-normal">
      <p>{!! Str::words($item->description, '40', '...') !!}
        <a href="{{ route('posts.comments.index',$item->id) }}">..Read More</a>
      </p>
    </div>
    ...
    <a href="{{ route('posts.comments.index',$item->id) }}" type="button" class="-m-2 flex gap-2 text-xs items-center rounded-full p-2 text-gray-600 hover:text-gray-800">
